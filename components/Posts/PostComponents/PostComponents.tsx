...
const Heading1 = ({ children }) => {
  return <h1 className='h3 font-weight-bold heading-color pb-3 pt-2'>{children}</h1>;
};
...
const Heading3 = ({ children }) => {
  return <h2 className='h5 font-weight-bold heading-color py-2 ml-4'>{children}</h2>;
};

const Paragraph = (props) => {
  return <p className={`text-left ${styles.fontSize}`} style={{ lineHeight: 2.3 }} {...props} />;
};
