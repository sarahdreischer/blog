...
Becoming a Software Developer if you don't have a Computer Science degree can be confusing and time-intensive. If you're eager to get your foot in the door here are
several options:

1. Joining a Coding Bootcamp. This will take about 8 weeks and can cost anywhere between 7,000 and 20,000£.

2. Joining a company that would hire and train you without any prior coding knowledge.

3. Learning to code by yourself

If you're lacking the time or resources to take up a Coding Bootcamp course and there's no job in sight that doesn't require you to be a professional developer already, then learning in your own time is always a great option.
